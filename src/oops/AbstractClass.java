 ...
 */
 ...
 public class AbstractClass {
    ...
    public static void main(String[] args) {
        ...
        /*
         * ` oops.AbstractClass ab = new oops.AbstractClass(); `
         * 
         * Above code will give compile time error
         * E) Class.java:30: error: oops.AbstractClass is abstract; cannot be instantiated
         */
         ...
         // This will call child printTime() & printCount() & time variable of Child class
 ...
 * Because ChildOfAbstractClass extends abstractclass `oops.AbstractClass` and
 * ChildOfAbstractClass is not abstract
 * 
 * E) Class.java:53: error: ChildOfAbstractClass is not abstract and does not override abstract method set(int) in oops.AbstractClass
 * E) class ChildOfAbstractClass extends oops.AbstractClass {
 * E) ^
 */
